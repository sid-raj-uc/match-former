...
from .utils.dataloader import get_local_split
from .utils.misc import tqdm_joblib
...
class MultiSceneDataModule(pl.LightningDataModule):
    ...
    def __init__(self, args, config):
        ...
        self.coarse_scale = 1 / config.MATCHFORMER.RESOLUTION[0]  # 0.125. for training loftr.
